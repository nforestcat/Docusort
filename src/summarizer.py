...
from src.utils import log_message, extract_text_from_pdf, calculate_file_hash, ensure_api_key
import fitz
...
def summarize_and_rename_info(text: str):
    ...
    """
    try:
        response = c.models.generate_content(model=MODELS[current_model_idx], contents=prompt)
